...
public class Node {
    ...
    private SftpDriverConfig sftpDriverConfig;
    ...
    public SftpDriverConfig getSftpDriverConfig() {
        return sftpDriverConfig;
    }

    public void setSftpDriverConfig(SftpDriverConfig sftpDriverConfig) {
        this.sftpDriverConfig = sftpDriverConfig;
    }
