...
public final class SftpService {
    ...
    private volatile ChannelSftp sftp;
    ...
    public SFtpEntry getRootEntry(String path){
        SFtpEntry targetEntry = new SFtpEntry();
        targetEntry.setPath("/root");
        targetEntry.setFilename("/root");
        targetEntry.setLongname("/root");
        try {
            targetEntry.setAttrs(sftp.stat("/root"));
...
//    public boolean hasChildFolder(String ) throws IOException {
